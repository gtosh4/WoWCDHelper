...
export const classes: {[className: string]: WowClass} = {
  deathknight: {
...
export const spells: {[id: number]: Spell} = {
  ...
  322118: {id: 322118, name: "Invoke Yu'lon", icon: "https://media.wowdb.com/wow/icons/large/ability_monk_dragonkick.jpg", cd: 180},
  ...
  109964: {id: 109964, name: "Spirit Shell", icon: "https://icons.wowdb.com/icons/large/ability_shaman_astralshift.jpg", cd: 60},
  ...
  51052:  {id: 51052,  name: "Anti-Magic Zone", icon: "https://media.wowdb.com/wow/icons/large/spell_deathknight_antimagiczone.jpg", cd: 120},
}
